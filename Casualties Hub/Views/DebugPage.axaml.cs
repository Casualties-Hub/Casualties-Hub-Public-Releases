...
public partial class DebugPage : UserControl
{
    ...
    public DebugPage(Action<string> setStatus)
    {
        ...
        this.FindControl<Button>("OpenLogsFolderButton")!.Click += (_, _) => DesktopShell.OpenFolder(DebugLogService.LogDirectory);
    ...
    private void OpenCurrentLog()
    {
        try
        {
            ...
            DesktopShell.OpenFile(DebugLogService.CurrentSessionLogPath);
