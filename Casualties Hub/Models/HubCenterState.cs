...
public sealed class HubCenterState
{
    ...
    public bool ServiceInMaintenance { get; init; }
    ...
    public int ActiveUsersLastTwoHours { get; init; }
    public int ActiveUsersLastDay { get; init; }
    public int ActiveUsersLastWeek { get; init; }
